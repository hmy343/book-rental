...
.k_detail_bg {
	background-image: url("./img/k_detail_bg.jpg") !important;
}
...
<body>
	...
	<main>
		...
		<div class="container detail_wrapper">
			<div class="row flex-nowrap" id="bookDetailInfo" action="bookinfo"
				method="get">
				<div class="col">
					<div id=list0 class="tumbnail ratio ratio-1x1">
						<img class="rounded mx-auto d-block"
							src="https://www.cbc.ca/kidsnews/content/_card_resize/BlueMonday_thumbnail.jpg" />
					</div>
					<div class="row" style="box-sizing: border-box !important;">
						<button id="rental_btn" type="submit"
							class="btn btn-outline-primary">대여하기</button>
					</div>
				</div>
