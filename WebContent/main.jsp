...
<style>
  .search_box {display: flex; justify-content: center; align-items: center; margin: 60px 0;}
</style>
...
<body>
	...
	<div class="tm-hero d-flex justify-content-center align-items-center">
        ...
        <div class="d-flex tm-search-form">
            ...
            <button class="btn btn-outline-primary tm-search-btn" type="submit" onclick="search()">
