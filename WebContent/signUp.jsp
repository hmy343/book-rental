...
<body class="bg-light">
	...
	<div class="container">
		<main>
			...
			<form name="writeForm" action="joinus" method="post"
				class="needs-validation" onSubmit='return checkValid()' novalidate>
				<div class="input-group mb-3">
					<div class="col">
						<label for="newUsId" class="form-label">User ID</label> <input
							id="newUsIdVal" type="text" name="newUsId" class="form-control" />
				...
				<div class="input-group mb-3">
					<div class="col">
						<label for="newUsPw" class="form-label">비밀번호</label> <input
							type="password" name="newUsPw" class="form-control" />
					</div>
				</div>
				<div class="input-group mb-3">
					<div class="col">
				...
				<div class="input-group mb-3">
					...
					<div class="col">
						...
						<div class="form-check">
							<label class="form-check-label" for="same-address">이메일 수신
								동의</label> <input type="checkbox" name="usEmailAgree"
